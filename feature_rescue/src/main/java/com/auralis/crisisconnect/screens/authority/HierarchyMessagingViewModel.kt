...
import com.arpit.utmesh.messaging.HierarchyChannel
import com.arpit.utmesh.messaging.HierarchyChannelKey
import com.arpit.utmesh.messaging.HierarchyMessage
import com.arpit.utmesh.messaging.HierarchyMessagingClient
import com.arpit.utmesh.messaging.HierarchyPeer
...
class HierarchyMessagingViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private var callSignaling: com.arpit.utmesh.messaging.call.AuthorityCallSignaling? = null
    ...
    fun openConversation(channel: HierarchyChannel, peer: HierarchyPeer) {
        ...
        if (uid != null) {
            ...
            callSignaling = com.arpit.utmesh.messaging.call.AuthorityCallSignaling(
                channelId = channel.channelId,
                myUid = uid,
                kind = com.arpit.utmesh.messaging.call.AuthorityCallSignaling.ChannelKind.HIERARCHY,
