...
import com.arpit.utmesh.screens.MainScreen
import com.arpit.utmesh.screens.AddFromContactsScreen
import com.arpit.utmesh.screens.NewChatScreen
import com.arpit.utmesh.screens.authority.AuthorityChannelsScreen
import com.arpit.utmesh.screens.authority.AuthorityChannelThreadScreen
import com.arpit.utmesh.screens.authority.AuthorityContactPickerScreen
import com.arpit.utmesh.screens.Guide.GuideMainScreen
import com.arpit.utmesh.screens.ToolsMainScreen
import com.arpit.utmesh.screens.TrustDossierScreen
import com.arpit.utmesh.screens.SettingsScreen
import com.arpit.utmesh.screens.AdvancedSettingsScreen
import com.arpit.utmesh.screens.settings.ChildProfileScreen
import com.arpit.utmesh.screens.settings.ProfileScreen
import com.arpit.utmesh.screens.settings.SosEmergencyContactsScreen
import com.arpit.utmesh.screens.Tools.MetalDetectorScreen
import com.arpit.utmesh.screens.Tools.SignalFinderScreen
import com.arpit.utmesh.screens.Tools.CompassScreen
import com.arpit.utmesh.screens.Tools.FlashlightScreen
import com.arpit.utmesh.screens.Tools.BreadcrumbTrailScreen
import com.arpit.utmesh.screens.Tools.CprAssistScreen
import com.arpit.utmesh.screens.Tools.OfflineMapScreen
import com.arpit.utmesh.screens.Tools.RecentDisastersScreen
import com.arpit.utmesh.screens.Tools.SensorToolScreen
import com.arpit.utmesh.screens.Tools.WhistleScreen
import com.arpit.utmesh.screens.Chat.ChatScreen
import com.arpit.utmesh.screens.Chat.ChatInfoScreen
import com.arpit.utmesh.screens.Chat.BleChatScreen
import com.arpit.utmesh.screens.Chat.GattMeshScreen
import com.arpit.utmesh.screens.SOSScreen
import com.arpit.utmesh.screens.SosCountdownScreen
import com.arpit.utmesh.ui.cert.CertificateProvisioningBanner
...
import com.arpit.utmesh.messaging.call.InternetCallForegroundService
import com.arpit.utmesh.messaging.call.InternetCallManager
import com.arpit.utmesh.screens.Chat.InternetCallOverlay
import com.arpit.utmesh.screens.Chat.InternetCallOverlayHost
...
import com.arpit.utmesh.data.local.ContactAvatarStorage
import com.arpit.utmesh.feature.RescueFeatureManager
import com.arpit.utmesh.feature.RescueFeatureRedirectScreen
import com.arpit.utmesh.navigation.navigateBottomBar
import com.arpit.utmesh.ui.components.NavbarSettingsCache
import kotlinx.coroutines.flow.map
import com.arpit.utmesh.navigation.resolveConversationRoute
import com.arpit.utmesh.screens.Chat.CallOverlay
import com.arpit.utmesh.ui.theme.DisasterCommunicationSystemTheme
import com.arpit.utmesh.screens.Chat.ChatSessionCodeScreen
import com.arpit.utmesh.screens.QR.ChatEncryptionSetupScreen
import com.arpit.utmesh.screens.QR.QrScannerScreen
import com.arpit.utmesh.screens.Chat.resolveChatDisplayName
import com.arpit.utmesh.data.database.DatabaseInitializer
import com.arpit.utmesh.security.EnterpriseSsoBridge
import com.arpit.utmesh.security.SecurityRepository
                                ...
                                composable(
                                    ...
                                    AuthorityChannelThreadScreen(
                                        ...
                                        scopeType = if (
                                            ...
                                            com.arpit.utmesh.messaging.AuthorityMlsScopeType.AGENCY
                                        } else {
                                            com.arpit.utmesh.messaging.AuthorityMlsScopeType.HIERARCHY
                                        },
                                    )
                                }
...
composable("metal_detector") { MetalDetectorScreen(navController) }
                        ...
                        com.arpit.utmesh.screens.Chat.SfuCallOverlayHost(this@MainActivity)
    ...
    private fun startRfcommForegroundServiceIfNeeded() {
        ...
        ContextCompat.startForegroundService(
            this,
            Intent(this, com.arpit.utmesh.service.RfcommForegroundService::class.java)
        )
    ...
    /** Catches the `utmesh://sso/callback` deep link returned by the web enterprise-SSO flow. */
