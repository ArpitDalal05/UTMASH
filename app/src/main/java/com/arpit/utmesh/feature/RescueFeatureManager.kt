package com.arpit.utmesh.feature
...
class RescueFeatureManager(private val context: Context) {
    ...
    companion object {
        ...
        const val RESCUE_ACTIVITY_CLASS_NAME =
            "com.arpit.utmesh.feature.rescue.RescueActivity"
        const val RESCUE_CLIENT_SERVICE_CLASS_NAME =
            "com.arpit.utmesh.service.GattRescueClientService"
        const val MESH_AWARE_SERVICE_CLASS_NAME =
            "com.arpit.utmesh.service.mesh.MeshAwareService"
        const val AUTHORITY_MESH_SERVICE_CLASS_NAME =
            "com.arpit.utmesh.service.mesh.AuthorityMeshForegroundService"
        const val CRISIS_LINK_SERVICE_CLASS_NAME =
            "com.arpit.utmesh.service.CrisisLinkForegroundService"
        ...
        const val ACTION_SIGNAL_LOCATION_UPDATED =
            "com.arpit.utmesh.action.SIGNAL_LOCATION_UPDATED"
