package com.arpit.utmesh.data.signal
 ...
 * SQLCipher-encrypted [com.arpit.utmesh.data.AppDatabase], so the serialized records —
 ...
 * ([com.arpit.utmesh.messaging.signal.AndroidSignalProtocolStore]) round-trips them through
