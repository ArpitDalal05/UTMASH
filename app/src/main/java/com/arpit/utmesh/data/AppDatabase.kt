...
@Database(
    entities = [
        ...
        com.arpit.utmesh.data.signal.SignalIdentityEntity::class,
        com.arpit.utmesh.data.signal.SignalSessionEntity::class,
        com.arpit.utmesh.data.signal.SignalPreKeyEntity::class,
        com.arpit.utmesh.data.signal.SignalSignedPreKeyEntity::class,
        com.arpit.utmesh.data.signal.SignalKyberPreKeyEntity::class,
        com.arpit.utmesh.data.signal.SignalSenderKeyEntity::class,
    ],
    version = 29
)
...
abstract class AppDatabase : RoomDatabase() {
    ...
    abstract fun signalStoreDao(): com.arpit.utmesh.data.signal.SignalStoreDao
    ...
    companion object {
        ...
        // cannot touch existing rows. Columns mirror com.arpit.utmesh.data.signal entities.
