...
import com.arpit.utmesh.messaging.call.sfu.SfuCallState
import com.arpit.utmesh.messaging.call.sfu.SfuUiCall
...
class InternetCallForegroundService : Service() {
    ...
    companion object {
        private const val ACTION_STOP = "com.arpit.utmesh.messaging.call.ACTION_STOP"
        private const val ACTION_ENABLE_MEDIA_PROJECTION =
            "com.arpit.utmesh.messaging.call.ACTION_ENABLE_MEDIA_PROJECTION"
