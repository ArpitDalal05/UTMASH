...
import com.arpit.utmesh.messaging.MessageContentCodec
 ...
 * of [com.arpit.utmesh.messaging.E2eEnvelope] for the forward-secret transport — the INNER
...
class SignalMessageTransport(private val store: SignalProtocolStore) {
    ...
    companion object {
        /** One logical device per UT Mesh account (no multi-device today). */
