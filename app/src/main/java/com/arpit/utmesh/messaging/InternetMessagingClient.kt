...
/** An address-book number that turned out to belong to a discoverable UT Mesh user. */
...
class InternetMessagingClient(
     ...
     * get back only the ones that belong to discoverable UT Mesh users. The server never
