package com.arpit.utmesh.messaging.call

import android.content.Context
import android.util.Log
import com.arpit.utmesh.R
import com.arpit.utmesh.messaging.HierarchyMessagingClient
import com.arpit.utmesh.messaging.AuthorityMlsCallGate
 ...
 *
 * Started once from [com.arpit.utmesh.messaging.MessagingBootstrap] after sign-in; a non-agency
    ...
    fun start(context: Context) {
        ...
        scope.launch {
            ...
            if (com.arpit.utmesh.messaging.call.sfu.SfuCallConfig.ENABLED) {
                com.arpit.utmesh.messaging.call.sfu.SfuAuthorityCallManager.init(appContext)
            }
...
private fun AuthorityCallSignaling.attachSfuRouting(
    ...
    if (!com.arpit.utmesh.messaging.call.sfu.SfuCallConfig.ENABLED) return
    onSfuSignal = { from, signal ->
        if (signal.optString("type") != "offer") {
            com.arpit.utmesh.messaging.call.sfu.SfuAuthorityCallManager
