...
class OfflineDownloadService : Service() {
    ...
    private fun handleStart() {
        ...
        startForeground(
            ...
            NotificationCompat.Builder(this, OfflineDownloadNotification.CHANNEL_ID)
                .setSmallIcon(com.arpit.utmesh.R.drawable.ic_stat_download)
                .setContentTitle(getString(com.arpit.utmesh.R.string.offline_notification_preparing))
    ...
    companion object {
        private const val ACTION_START = "com.arpit.utmesh.service.action.START"
        private const val ACTION_PAUSE = "com.arpit.utmesh.service.action.PAUSE"
        private const val ACTION_RESUME = "com.arpit.utmesh.service.action.RESUME"
        private const val ACTION_CANCEL = "com.arpit.utmesh.service.action.CANCEL"
