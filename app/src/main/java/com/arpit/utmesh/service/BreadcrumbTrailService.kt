...
import com.arpit.utmesh.screens.Tools.BreadcrumbTrailMode
import com.arpit.utmesh.screens.Tools.BreadcrumbTrailRepository
...
class BreadcrumbTrailService : Service(), LocationListener {
    ...
    companion object {
        ...
        private const val ACTION_START = "com.arpit.utmesh.breadcrumb.START"
        private const val ACTION_STOP = "com.arpit.utmesh.breadcrumb.STOP"
