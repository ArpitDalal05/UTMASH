...
-keep class com.arpit.utmesh.data.AppDatabase_Impl { *; }
-keep class com.arpit.utmesh.data.offline.OfflineDatabase_Impl { *; }
...
-keepclasseswithmembernames class com.arpit.utmesh.messaging.call.sfu.MlsWorker {
    native <methods>;
}
-keepclasseswithmembernames class com.arpit.utmesh.messaging.call.sfu.MlsFrameCrypto {
    native <methods>;
}
